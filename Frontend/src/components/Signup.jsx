      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-sm shadow-2xl rounded-3xl p-8 border border-white/20">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <a href='/login' className='text-orange-600 hover:text-orange-700 font-semibold transition-colors duration-200'>
                Sign In
              </a>
            </p>
          </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-500 text-sm">
            ...
            <a href="#" className="text-orange-600 hover:text-orange-700">Terms of Service</a> and{' '}
